...
//---------------------------------------------------------------------
void verify(int no_time_steps, char *Class, logical *verified, int rank,
        int size, int root, int kstart, int kend, int kdelta, int *kdeltas, int *disps)
{
    ...
    //---------------------------------------------------------------------
    error_norm(xce,rank,size,root, kstart, kend, kdelta);
    
    compute_rhs(rank,size,root, kstart, kend, kdelta,kdeltas,disps);

    rhs_norm(xcr,rank,size,root, kstart, kend, kdelta);
