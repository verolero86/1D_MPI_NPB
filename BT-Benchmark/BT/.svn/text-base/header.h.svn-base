...
/* common /fields/ */
// extern double allu   [KMAX][JMAXP+1][IMAXP+1][5];
...
// extern double allforcing[KMAX][JMAXP+1][IMAXP+1][5];
...
extern double rhsp   [JMAXP+1][KMAX][IMAXP+1][5];
// extern double rhsp2   [JMAXP][KMAX][IMAXP+1][5];
//
extern double tflip;
extern double tflipstart;
extern double tflipend;
...
void exact_rhs(int rank, int size, int root, int kstart, int kend, int kdelta);
void set_constants();
...
void x_solve(int rank, int size, int root, int kstart, int kend, int kdelta);
...
void verify(int no_time_steps, char *class, logical *verified, int rank, int size, int root, int kstart, int kend, int kdelta, int *kdeltas, int *disps);
